...
# added
let-env PATH = ($env.PATH | split row (char esep) | append '/home/linuxbrew/.linuxbrew/bin')
let-env PATH = ($env.PATH | split row (char esep) | append '/home/ko/.local/bin')
let-env PATH = ($env.PATH | split row (char esep) | append '/home/ko/.cargo/bin/')
